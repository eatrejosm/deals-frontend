...
const customTheme: CustomFlowbiteTheme = {
  button: {
    ...
    color: {
      primary:
        "border border-transparent bg-blue text-white focus:ring-4 focus:ring-blue-300 enabled:hover:bg-blue-800 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800",
